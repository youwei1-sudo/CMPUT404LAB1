HTTP/1.1 200 OK
Date: Tue, 12 Jan 2021 05:15:54 GMT
...
<DT> HTTP_USER_AGENT <DD> curl/7.68.0
<DT> PATH <DD> /usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin
<DT> QUERY_STRING <DD> 
<DT> REMOTE_ADDR <DD> 68.150.212.105
<DT> REMOTE_PORT <DD> 46196
...
<DT> SERVER_ADMIN <DD> helpdesk@cs.ualberta.ca
...
<DT> UNIQUE_ID <DD> X-0winxtYx2UxDvk@gvm5QAAAAE
</DL>
